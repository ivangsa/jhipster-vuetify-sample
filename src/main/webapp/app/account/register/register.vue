      ...
      <v-card class="ma-4">
        <v-card-title primary-title>
            ...
            <v-layout wrap>
                ...
                <v-flex xs12>
                    <v-text-field v-model="registerAccount.login" @input="$v.registerAccount.login.$touch()" :label="$t('global.form.username')" 
                ...
                <v-flex xs12>
                    <v-text-field v-model="registerAccount.email" @input="$v.registerAccount.email.$touch()" :label="$t('global.form.email')" 
                ...
                <v-flex xs12>
                    <v-text-field type="password" v-model="registerAccount.password" @input="$v.registerAccount.password.$touch()" :label="$t('global.form.newpassword')" 
                ...
                <v-flex xs12>
                    <v-text-field type="password" v-model="confirmPassword" @input="$v.confirmPassword.$touch()" :label="$t('global.form.confirmpassword')" 
